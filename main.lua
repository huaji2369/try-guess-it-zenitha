...
scene_menu.widgetList={
    ...
    --trophy
    {type='button',x=110,y=400,w=80,h=80,onClick=function() mode=1 SCN.go('trophy') end,visibleFunc=function() return STAT.mastered[1] end,color=modeColor[1]},
    {type='button',x=110,y=500,w=80,h=80,onClick=function() mode=2 SCN.go('trophy') end,visibleFunc=function() return STAT.mastered[2] end,color=modeColor[2]},
    {type='button',x=110,y=600,w=80,h=80,onClick=function() mode=3 SCN.go('trophy') end,visibleFunc=function() return STAT.mastered[3] end,color=modeColor[3]},
    {type='button',x=110,y=700,w=80,h=80,onClick=function() mode=4 SCN.go('trophy') end,visibleFunc=function() return STAT.mastered[4] end,color=modeColor[4]},
    {type='button',x=110,y=800,w=80,h=80,onClick=function() mode=5 SCN.go('trophy') end,visibleFunc=function() return STAT.mastered[5] end,color=modeColor[5]},
